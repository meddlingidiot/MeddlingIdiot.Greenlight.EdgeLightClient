...
/// testing — clicks land on the strip instead of on whatever is underneath.
/// </remarks>
...
internal static class ClickThroughNative
{
    ...
    public static void Apply(IntPtr hwnd)
    {
        ...
        // uniform fade"; the strip's own translucency comes from how they are drawn.
    ...
    /// startup gets you a strip that is on top until the first time somebody clicks the
    /// taskbar and then silently behind it whenever the mouse goes there, which looks exactly
