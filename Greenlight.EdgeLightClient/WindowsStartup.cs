...
/// <summary>
/// Whether the strip comes back when Windows does. One value under the current user's
...
public static class WindowsStartup
{
    ...
    /// </summary>
    private const string ValueName = "Greenlight Edge Light";

    /// <summary>Whether Windows is currently set to start the strip.</summary>
    ...
    /// <summary>Ask Windows to start the strip, or stop asking. Returns what it actually is afterwards.</summary>
    ...
    /// </summary>
    /// <remarks>
    /// A Velopack install looks like <c>…\Greenlight.EdgeLightClient\current\Greenlight.EdgeLightClient.exe</c>,
