...
internal static class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        VelopackBootstrapper.Startup("Greenlight.EdgeLightClient", args);
        ...
        using var single = new Mutex(initiallyOwned: true, @"Local\Greenlight.EdgeLightClient", out var first);
        if (!first) return;
